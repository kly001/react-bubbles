...
- [ ] Explain what a token is used for.
  ...
  A token is a string of cryptic text that is stored in local storage. It provides authentication
  to the server indicating that the user has permission to use specific services.

-------------------------------------------------------------------------------------------------------------------------

- [ ] What steps can you take in your web apps to keep your data secure?

  You can implement protected routes using an authentication token and Redirect.

-------------------------------------------------------------------------------------------------------------------------

- [ ] Describe how web servers work.

  A web server is a physical computer that is connected to the internet.  It stores code for different websites
  to be shared on the internet at all times.  Its main purpose is to 'serve' web pages it retrieves from your
  project code to users upon request.
